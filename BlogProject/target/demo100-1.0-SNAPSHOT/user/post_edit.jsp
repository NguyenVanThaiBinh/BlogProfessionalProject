...
<div class="container" style="margin-top: 0em;">
    ...
    padding-bottom: 1em;">
            <h2 class="text-center" style="font-size: 39px;">Edit Post</h2>
        ...
        <%
          ...
          Post  post = (Post) request.getAttribute("user");
        %>
        </div>
        <div class="panel-body">
            <form method="post" style="float: right" id="usrform">
                <div class="form-group">
                    ...
                    <input required="true" type="text" value="<%=post.getTitle()%>" class="form-control" name="title" id="title">
                </div>
                <div class="form-group">
                    <label for="description">Description:</label>

                    <input required="true" type="text" class="form-control" value="<%=post.getImg_dres()%>" id="description" name="description">
                </div>
                <div class="form-group">
                    <label for="myTextarea">Content</label>
                    <textarea form="usrform" class="form-control" id="myTextarea"  name="content" rows="4"></textarea>
                </div>
                <div class="form-group">
                    <label for="img_path">Image Path:</label>
                    <input required="true" type="text" class="form-control"value="<%=post.getImg_path()%>" id="img_path" name="img_path">
                </div>
                <div class="form-group">
                ...
                <button type="submit" id="submit" class="btn btn-success" style=" background-color: lightseagreen;">Edit Now!</button>
...
<script>
    document.getElementById("myTextarea").value = "<%=post.getContent()%>";
