...
<div class="wrapper row2">
    <nav id="mainav" class="hoc clear">
        <ul class="clear">
            <li><a href="account">
                <button type="button" class="btn btn-secondary"
                        style="margin-left: -35em;background-color: #314c5b;">Account
                </button>
            </a></li>
            <li><a href="create-post">
                <button type="button" class="btn btn-secondary"
                        style="margin-left: -19em;background-color: #314c5b;">Create Post
                </button>
            </a></li>
            <li><a href="post-check">
                <button type="button" class="btn btn-secondary"
                        style="margin-left: -5em;background-color: #314c5b;">Post Manage
                </button>
            </a></li>
            ...
            <%
                String name = (String) request.getSession().getAttribute("userNameLogin");
            %>
            <li><a href="home">Logout here</a></li>
            <li><p id="binhhu" style="color: #24558a; margin-right: -27em;">Welcome back<b> <%=name%></b> ! </p></li>
        ...
        <form action="#"><select onchange="location = this.value;">
            ...
            <option value="http://localhost:8089/create-post">Create Post</option>
            <option value="http://localhost:8089/post-check">Post Manage</option>
            <option value="http://localhost:8089/account">Account</option>
                            ...
                            <div class="excerpt">
                                ...
                                <div class="clear">
                                    <footer class="fl_right">
                                        <a href="#" style="margin-right: 5em;">Read More <i class="fas fa-angle-right"></i></a>
                                    </footer>
