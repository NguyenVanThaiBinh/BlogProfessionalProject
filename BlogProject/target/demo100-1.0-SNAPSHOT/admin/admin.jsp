        ...
        <ul class="clear">
            <li><a href="user-manage">
                <button type="button" class="btn btn-secondary"
                        style="margin-left: -19em;background-color: #314c5b;">User Manage
                </button>
            </a></li>
            <li><a href="post-manage">
                <button type="button" class="btn btn-secondary"
            ...
            <li><p id="binhhu" style="color: #24558a; margin-right: -27em;"><b>Welcome back Binh Hu</b> </p></li>

        </ul>

        <form action="#"><select onchange="location = this.value;">
            <option selected="selected" value="">Welcome back Binh Hu - Choose Menu</option>


            <option value="http://localhost:8089/user-manage">User Manage</option>
